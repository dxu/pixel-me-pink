...
},{"./devTools":193,"./persistState":195}],195:[function(require,module,exports){
'use strict';
...
},{"./utils/isPlainObject":202}],197:[function(require,module,exports){
'use strict';
...
},{"./createStore":196,"./utils/applyMiddleware":198,"./utils/bindActionCreators":199,"./utils/combineReducers":200,"./utils/compose":201}],198:[function(require,module,exports){
'use strict';
...
},{"../utils/mapValues":203}],200:[function(require,module,exports){
(function (process){
'use strict';
...
},{"../createStore":196,"../utils/isPlainObject":202,"../utils/mapValues":203,"../utils/pick":204,"_process":192}],201:[function(require,module,exports){
/**
...
var ADD_PIXEL = 'ADD_PIXEL';

exports.ADD_PIXEL = ADD_PIXEL;
/*
 * ADD_PIXEL:
 * data: {
 *   x: x-coordinate
 ...
 * }
 */
var REMOVE_PIXEL = 'REMOVE_PIXEL';
exports.REMOVE_PIXEL = REMOVE_PIXEL;
...
var dispatchers = _interopRequireWildcard(_dispatchers);
...
var scaleFactor = undefined,
    storeMemo = undefined; // the previous state of each row
var MAX_PIXELS = 30;
...
(function () {
  var store = undefined,
      ...
      rowSelectors = undefined;
  window.store = store = (0, _store.setupStore)();
  ...
  $(function () {
    ...
    var _loop = function (i) {
      rowSelectors.push(function (state) {
    ...
    // out selectors
    rowSelection = (0, _reselect.createSelector)(rowSelectors, function () {
    ...
    unsubscribe = store.subscribe(function () {
      ...
      for (var row in rowMap.pixels) {
        ...
        if (rowMap.pixels[row] && rowMap.pixels[row] !== storeMemo.pixels[row]) {
          ...
          // update the color
          for (var column in rowMap.pixels[row]) {
            // console.log('once')
            ...
            var pixel1 = rowMap.pixels[row] && rowMap.pixels[row][column] || {},
                pixel2 = storeMemo.pixels[row] && storeMemo.pixels[row][column] || {};
            if (!(0, _util.areSameColor)(pixel1.colors, pixel2.colors)) {
...
},{"./dispatchers":208,"./store":210,"./util":211,"reselect":205}],208:[function(require,module,exports){
'use strict';
...
var addPixel = function addPixel(options) {
  var _options$color = options.color;
  var color = _options$color === undefined ? {} : _options$color;
  var _options$coords = options.coords;
  var coords = _options$coords === undefined ? {} : _options$coords;
  ...
  (0, _store.getStore)().dispatch({
    type: _actions.ADD_PIXEL,
    data: {
      color: color,
      coords: coords
    }
...
},{"./actions":206,"./store":210}],209:[function(require,module,exports){
'use strict';
...
var pixelStore = undefined,
    observablePixelStore = undefined;

var pixelReducers = (0, _redux.combineReducers)({
  pixels: _reducers.pixels
});

var createEnhancedStore = (0, _redux.compose)(
...
},{"./reducers":209,"redux":197,"redux-devtools":194}],211:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, '__esModule', {
  value: true
});
exports.areSameColor = areSameColor;

function areSameColor(color1, color2) {
  if (!(color1 && color2)) {
    return false;
  }
  var a = color1.r === color2.r && color1.g === color2.g && color1.b === color2.b && color1.a === color2.a;
  console.log('a', a);
  return a;
}
